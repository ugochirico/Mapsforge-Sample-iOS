 ...
 */
inline jlong JavaMathBigDecimal_get_INFLATED();
...
inline IOSCharArray *JavaMathBigDecimal_StringBuilderHelper_get_DIGIT_TENS();
/*! INTERNAL ONLY - Use accessor function from above. */
...
inline IOSCharArray *JavaMathBigDecimal_StringBuilderHelper_get_DIGIT_ONES();
/*! INTERNAL ONLY - Use accessor function from above. */
...
FOUNDATION_EXPORT JavaMathBigDecimal_StringBuilderHelper *new_JavaMathBigDecimal_StringBuilderHelper_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT JavaMathBigDecimal_StringBuilderHelper *create_JavaMathBigDecimal_StringBuilderHelper_init();
