...
/*!
 ...
 @throw NullPointerExceptionis <code>name</code> is <code>null</code>
 */
...
/*!
 @brief Cancels the <code>Timer</code> and all scheduled tasks.If there is a
  currently running task it is not affected.
...
/*!
 @brief Removes all canceled tasks from the task queue.If there are no
...
/*!
 @brief Schedule a task for single execution.If <code>when</code> is less than the
