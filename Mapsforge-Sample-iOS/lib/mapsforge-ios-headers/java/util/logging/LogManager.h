...
FOUNDATION_EXPORT JavaUtilLoggingLogManager_SystemLoggerContext *new_JavaUtilLoggingLogManager_SystemLoggerContext_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT JavaUtilLoggingLogManager_SystemLoggerContext *create_JavaUtilLoggingLogManager_SystemLoggerContext_init();
