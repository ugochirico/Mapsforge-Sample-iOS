...
@interface JavaUtilConcurrentForkJoinPool : JavaUtilConcurrentAbstractExecutorService {
 @public
  volatile_jlong pad00_;
  volatile_jlong pad01_;
  volatile_jlong pad02_;
  volatile_jlong pad03_;
  volatile_jlong pad04_;
  volatile_jlong pad05_;
  volatile_jlong pad06_;
...
/*!
 @brief Blocks in accord with the given blocker.If the current thread
...
@endcode
 ...
 @throw InterruptedExceptionif blocker.block did so
 */
...
/*!
 @brief Stripped-down variant of awaitJoin used by timed joins.Tries
  to help join only while there is continuous progress.
 (Caller
...
/*!
 @brief Per-thread submission bookkeeping.Shared across all pools
...
/*!
 @brief Per-thread records for threads that submit to pools.Currently
  holds only pseudo-random seed / index that is used to choose
  submission queues in method externalPush.
