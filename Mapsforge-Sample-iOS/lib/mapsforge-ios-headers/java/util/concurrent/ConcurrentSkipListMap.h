...
/*!
 @brief Compares using comparator or natural ordering.Used when the
...
/*!
 @brief Initializes or resets state.Needed by constructors, clone,
...
/*!
 @brief Submaps returned by <code>ConcurrentSkipListMap</code> submap operations
  ...
  in <code>IllegalArgumentException</code>.
