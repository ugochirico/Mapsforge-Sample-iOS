 ...
 */
inline jlong JavaUtilConcurrentLocksAbstractQueuedSynchronizer_get_SPIN_FOR_TIMEOUT_THRESHOLD();
...
inline jlong JavaUtilConcurrentLocksAbstractQueuedSynchronizer_Node_get_PREV();
/*! INTERNAL ONLY - Use accessor function from above. */
