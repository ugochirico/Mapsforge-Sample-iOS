...
/*!
 ...
 - seealso: #CE
 */
inline jint JavaUtilGregorianCalendar_get_BCE();
...
/*!
 ...
 - seealso: #BCE
 */
inline jint JavaUtilGregorianCalendar_get_CE();
#define JavaUtilGregorianCalendar_CE 1
J2OBJC_STATIC_FIELD_CONSTANT(JavaUtilGregorianCalendar, CE, jint)

inline IOSIntArray *JavaUtilGregorianCalendar_get_MONTH_LENGTH();
...
inline IOSIntArray *JavaUtilGregorianCalendar_get_LEAP_MONTH_LENGTH();
/*! INTERNAL ONLY - Use accessor function from above. */
...
inline IOSIntArray *JavaUtilGregorianCalendar_get_MIN_VALUES();
/*! INTERNAL ONLY - Use accessor function from above. */
...
inline IOSIntArray *JavaUtilGregorianCalendar_get_LEAST_MAX_VALUES();
/*! INTERNAL ONLY - Use accessor function from above. */
...
inline IOSIntArray *JavaUtilGregorianCalendar_get_MAX_VALUES();
/*! INTERNAL ONLY - Use accessor function from above. */
...
inline jlong JavaUtilGregorianCalendar_get_serialVersionUID();
...
inline jlong JavaUtilGregorianCalendar_get_DEFAULT_GREGORIAN_CUTOVER();
