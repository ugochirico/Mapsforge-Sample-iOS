...
/*!
 @brief Constructs a new <code>StringTokenizer</code> for the parameter string using
  whitespace as the delimiter.The <code>returnDelimiters</code> flag is set to 
 <code>false</code>.
...
/*!
 @brief Constructs a new <code>StringTokenizer</code> for the parameter string using
  the specified delimiters.The <code>returnDelimiters</code> flag is set to 
 <code>false</code>.
 If <code>delimiters</code> is <code>null</code>, this constructor
...
/*!
 @brief Constructs a new <code>StringTokenizer</code> for the parameter string using
  ...
  parameter <code>returnDelimiters</code> is <code>true</code>.If <code>delimiters</code>
 ...
 @param string the string to be tokenized.
 @param delimiters the delimiters to use.
 @param returnDelimiters<code>true</code>
...
/*!
 @brief Returns <code>true</code> if unprocessed tokens remain.This method is
...
/*!
 @brief Returns the next token in the string as an <code>Object</code>.This method is
  implemented in order to satisfy the <code>Enumeration</code> interface.
...
/*!
 @brief Returns the next token in the string as a <code>String</code>.The delimiters
