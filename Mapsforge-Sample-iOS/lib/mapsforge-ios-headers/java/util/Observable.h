...
/*!
 @brief Observable is used to notify a group of Observer objects when a change
  occurs.On creation, the set of observers is empty.
...
/*!
 @brief Adds the specified observer to the list of observers.If it is already
...
/*!
 @brief Removes the specified observer from the list of observers.Passing null
  won't do anything.
...
/*!
 @brief If <code>hasChanged()</code> returns <code>true</code>, calls the <code>update()</code>
  ...
  argument.Afterwards, calls <code>clearChanged()</code>.
 <p>
...
/*!
 @brief If <code>hasChanged()</code> returns <code>true</code>, calls the <code>update()</code>
  ...
  argument.Afterwards calls <code>clearChanged()</code>.
 @param data the argument passed to 
 <code>update()</code> .
 */
...
/*!
 @brief Clears the changed flag for this <code>Observable</code>.After calling 
 <code>clearChanged()</code>, <code>hasChanged()</code> will return <code>false</code>.
 */
- (void)clearChanged;

/*!
 @brief Sets the changed flag for this <code>Observable</code>.After calling 
