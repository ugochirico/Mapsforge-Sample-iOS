...
inline jlong JavaUtilTimeZone_get_serialVersionUID();
 ...
 */
inline JavaUtilTimeZone *JavaUtilTimeZone_get_NO_TIMEZONE();
...
FOUNDATION_EXPORT JavaUtilTimeZone *JavaUtilTimeZone_getDefaultRef();
