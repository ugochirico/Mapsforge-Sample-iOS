...
FOUNDATION_EXPORT JavaUtilZipZipEntry *new_JavaUtilZipZipEntry_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT JavaUtilZipZipEntry *create_JavaUtilZipZipEntry_init();
