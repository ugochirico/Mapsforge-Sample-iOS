 ...
 */
inline jlong JavaUtilLocale_get_serialVersionUID();
...
FOUNDATION_EXPORT JavaUtilLocale *JavaUtilLocale_initDefault();
...
/*!
 ...
 @since 1.7
 */
@interface JavaUtilLocale_Category : JavaLangEnum < NSCopying > {
 @public
 ...
 */
inline JavaUtilLocale_Category *JavaUtilLocale_Category_get_DISPLAY();
 ...
 */
inline JavaUtilLocale_Category *JavaUtilLocale_Category_get_FORMAT();
...
FOUNDATION_EXPORT IOSObjectArray *JavaUtilLocale_Category_values();
