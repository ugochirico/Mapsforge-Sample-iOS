...
/*!
 ...
 <code>\\p{javaWhitespace}</code> by default. 
 <p>Example:
  @code
...
/*!
 @brief Creates a <code>Scanner</code> with the specified <code>File</code> as input.The default charset
...
/*!
 @brief Creates a <code>Scanner</code> with the specified <code>File</code> as input.The specified charset
  is applied when reading the file.
 @param src the file to be scanned.
...
/*!
 @brief Creates a <code>Scanner</code> on the specified <code>InputStream</code>.The default charset is
  applied when decoding the input.
 @param src the 
 <code>InputStream</code>  to be scanned.
 */
- (instancetype)initWithJavaIoInputStream:(JavaIoInputStream *)src;

/*!
 @brief Creates a <code>Scanner</code> on the specified <code>InputStream</code>.The specified charset is
  applied when decoding the input.
 @param src the 
 <code>InputStream</code>  to be scanned.
 @param charsetName the encoding type of the 
...
/*!
 ...
 @param src the 
 <code>Readable</code>  to be scanned.
 */
...
/*!
 ...
 @param src the 
 <code>ReadableByteChannel</code>  to be scanned.
 */
...
/*!
 ...
 <code>Closeable</code>.If the <code>Scanner</code> has been closed, this method will have
  no effect.
 Any scanning operation called after calling this method will throw
...
/*!
 @brief Tries to find the pattern in the input.Delimiters are ignored.
 If the
...
/*!
 @brief Compiles the pattern string and tries to find a substring matching it in the input data.The
...
/*!
 ...
 If the pattern is found, the matched
...
/*!
 @brief Tries to find the pattern in the input between the current position and the specified 
 <code>horizon</code>.Delimiters are ignored.
 This call is the same as invoking 
...
/*!
 ...
 @param radix the radix used to translate the token into an 
 <code>int</code>             value.
...
/*!
 ...
 @throw IllegalStateExceptionif this <code>Scanner</code> is closed.
 */
...
/*!
 @brief Returns the next token.The token will be both prefixed and suffixed by
...
/*!
 @brief Returns the next token if it matches the specified pattern.The token
  will be both prefixed and suffixed by the delimiter that is currently
  being used (or a string that matches the delimiter pattern).
...
/*!
 @brief Returns the next token as a <code>BigDecimal</code>.This method will block if input is
  being read.
 If the next token can be translated into a <code>BigDecimal</code>
  ...
  mapped into ASCII digits via <code>int)</code>, and a
...
/*!
 ...
 <code>int)</code>, and a negative sign (-) is added if the 
 <code>Locale</code>-specific negative prefix or suffix was present. Finally the
  resulting String is passed to <code>int)</code>}
...
/*!
 @brief Returns the next token as a <code>boolean</code>.This method will block if input is
  being read.
...
/*!
 @brief Returns the next token as a <code>byte</code> with the specified radix.Will
  block if input is being read.
 If the next token can be translated into a 
 ...
 <code>int)</code>, and a negative sign (-) is added if the 
 <code>Locale</code>-specific negative prefix or suffix was present. Finally the
  resulting String is passed to <code>int)</code>} with
  the specified radix.
 @param radix the radix used to translate the token into 
 <code>byte</code>  value.
...
/*!
 @brief Returns the next token as a <code>double</code>.This method will block if input is being
  read.
 If the next token can be translated into a <code>double</code> the
 ...
 <code>Locale</code>-specific suffixes are removed. Then non-ASCII digits are mapped
  into ASCII digits via <code>int)</code>, and a negative
...
/*!
 @brief Returns the next token as a <code>float</code>.This method will block if input is being
  read.
 If the next token can be translated into a <code>float</code> the
  following is done: All <code>Locale</code>-specific prefixes, group separators, and 
 <code>Locale</code>-specific suffixes are removed. Then non-ASCII digits are mapped
  into ASCII digits via <code>int)</code>, and a negative
  sign (-) is added if the <code>Locale</code>-specific negative prefix or suffix was
...
/*!
 @brief Returns the next token as an <code>int</code> with the specified radix.This method will
  block if input is being read.
 If the next token can be translated into an 
...
/*!
 @brief Returns the next token as a <code>long</code> with the specified radix.This method will
  block if input is being read.
 If the next token can be translated into a 
...
/*!
 @brief Returns the next token as a <code>short</code> with the specified radix.This method will
  block if input is being read.
 If the next token can be translated into a 
...
/*!
 @brief Tries to use the specified string to construct a pattern and then uses
  ...
  delimiter will be ignored.
 This call is the same as invoke 
...
/*!
 @brief Returns a string representation of this <code>Scanner</code>.The information
  returned may be helpful for debugging.
 The format of the string is unspecified.
...
/*!
 ...
 @param pattern a string from which a 
 <code>Pattern</code>  can be compiled.
 @return this <code>Scanner</code>.
 */
...
/*!
 ...
 @param l the specified 
 <code>Locale</code>  to use.
 @return this <code>Scanner</code>.
 */
