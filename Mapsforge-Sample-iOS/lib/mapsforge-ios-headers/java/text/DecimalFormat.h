...
inline jint JavaTextDecimalFormat_get_currentSerialVersion();
...
inline jint JavaTextDecimalFormat_get_DOUBLE_INTEGER_DIGITS();
...
inline jint JavaTextDecimalFormat_get_DOUBLE_FRACTION_DIGITS();
...
inline jint JavaTextDecimalFormat_get_MAXIMUM_INTEGER_DIGITS();
...
inline jint JavaTextDecimalFormat_get_MAXIMUM_FRACTION_DIGITS();
...
inline jlong JavaTextDecimalFormat_get_serialVersionUID();
