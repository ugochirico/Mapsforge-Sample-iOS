...
/*!
 ...
 <tr class="TableHeadingColor"><th colspan="4">Proxies</th></tr>
  <tr><th>URL scheme</th><th>property name</th><th>description</th><th>default</th></tr>
 ...
 <tr class="TableHeadingColor"><th colspan="4">Proxies
 </th></tr>
  <tr><th>URL scheme</th><th>property name</th><th>description</th><th>default</th></tr>
...
/*!
 ...
 @param failure the exception which was thrown during connection      establishment.
 @throw IllegalArgumentExceptionif any argument is null.
 */
...
/*!
 @brief Returns the proxy servers to use on connections to <code>uri</code>.This list
  will contain <code>Proxy.NO_PROXY</code> if no proxy server should be used.
 @throw IllegalArgumentExceptionif <code>uri</code> is null.
 */
- (id<JavaUtilList>)selectWithJavaNetURI:(JavaNetURI *)uri;

/*!
 @brief Sets the default proxy selector.If <code>selector</code> is null, the current
