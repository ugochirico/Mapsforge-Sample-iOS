...
/*!
 @brief This class represents proxy server settings.A created instance of <code>Proxy</code>
  stores a type and an address and is immutable.
...
/*!
 ...
 @param type the proxy type of this instance.
 @param sa the proxy address of this instance.
...
/*!
 @brief Gets a textual representation of this <code>Proxy</code> instance.The string
...
/*!
 @brief Represents the proxy type setting <code>Proxy.Type.DIRECT</code>.It tells
  protocol handlers that there is no proxy to be used.
...
/*!
 @brief <code>Enum</code> class for the proxy type.Possible options are <code>DIRECT</code>
...
/*!
 @brief Direct connection.Connect without any proxy.
 */
inline JavaNetProxy_Type *JavaNetProxy_Type_get_DIRECT();
J2OBJC_ENUM_CONSTANT(JavaNetProxy_Type, DIRECT)

/*!
 @brief HTTP type proxy.It's often used by protocol handlers such as HTTP,
  HTTPS and FTP.
 */
