...
/*!
 ...
 <code>http://username:password@@host:8080/directory/file?query#fragment</code>
  ...
  <tr><td><code>part</code></td><td><code>//username:password@@host:8080/directory/file?query#fragment</code></td><td></td></tr>
 ...
 <h3>Absolute vs. Relative URIs</h3>
  URIs are either <code>or relative</code>.
  <ul>
...
@endcode
 ...
 <h3>Opaque vs. Hierarchical URIs</h3>
  Absolute URIs are either <code>or hierarchical</code>. Relative
...
/*!
 @brief Compares this URI with the given argument <code>uri</code>.This method will
  ...
  given argument.
 The return value <code>0</code> indicates that the two
...
/*!
 @brief Returns the URI formed by parsing <code>uri</code>.This method behaves
  identically to the string constructor but throws a different exception
  on failure.
 The constructor fails with a checked <code>URISyntaxException</code>
...
/*!
 @brief Returns the scheme of this URI, or null if this URI has no scheme.This
...
/*!
 @brief Returns true if this URI is opaque.Opaque URIs are absolute and have a
  scheme-specific part that does not start with a slash character.
 All
...
/*!
 @brief Creates a new URI instance by parsing the given string <code>relative</code>
  ...
  instance.
 @param relative the given string to create the new URI instance which has to
