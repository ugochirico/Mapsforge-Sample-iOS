...
/*!
 @brief A connection to a URL for reading or writing.For HTTP connections, see 
...
@endcode
 ...
 <h3>Timeouts</h3>
  <code>URLConnection</code> supports two timeouts: a <code>timeout</code>
  and a <code>timeout</code>. By default,
...
@interface JavaNetURLConnection : NSObject {
 @public
  ...
  remote resource.If this field is set to <code>true</code> the flags for
  ...
  jboolean doInput_;
  /*!
   @brief Unused by Android.This field can be accessed via <code>getAllowUserInteraction</code>
...
/*!
 @brief Adds the given property to the request header.Existing properties with
...
/*!
 @brief Opens a connection to the resource.This method will <strong>not</strong>
...
/*!
 @brief Returns <code>allowUserInteraction</code>.Unused by Android.
 */
...
/*!
 ...
 If none is found it will guess the content
...
/*!
 @brief Returns the default value of <code>allowUserInteraction</code>.Unused by Android.
 */
...
/*!
 @brief Returns the header value at the field position <code>pos</code> or <code>null</code>
  if the header has fewer than <code>pos</code> fields.The base
...
/*!
 @brief Returns the specified header value as a date in milliseconds since January
  1, 1970 GMT.Returns the <code>defaultValue</code> if no such header field
  could be found.
...
/*!
 @brief Returns the specified header value as a number.Returns the <code>defaultValue</code>
...
/*!
 ...
 <code>null</code> if there are fewer than <code>posn</code> fields.The base
  implementation of this method returns always <code>null</code>.
 <p>Some implementations (notably <code>HttpURLConnection</code>) include a mapping
  for the null key; in HTTP's case, this maps to the HTTP status line and is
  treated as being at position 0 when indexing into the header fields.
...
/*!
 @brief Returns an unmodifiable map of the response-header fields and values.The
  response-header field names are the key values of the map.
 The map values
...
/*!
 @brief Returns an <code>InputStream</code> for reading data from the resource pointed by
  this <code>URLConnection</code>.It throws an UnknownServiceException by
  default.
...
/*!
 @brief Returns a <code>Permission</code> object representing all needed permissions to
  ...
  necessary.
 By default, this method returns <code>AllPermission</code>.
...
/*!
 @brief Returns an unmodifiable map of general request properties used by this
  connection.The request property names are the key values of the map.
 The
...
/*!
 @brief Returns the value of the request header property specified by {code field}
  or <code>null</code> if there is no field with this name.The base
  implementation of this method returns always <code>null</code>.
...
/*!
 @brief Sets <code>allowUserInteraction</code>.Unused by Android.
 */
...
/*!
 ...
 <p><strong>Warning:</strong> if the hostname resolves to multiple IP
  addresses, this client will try each in <a href="http://www.ietf.org/rfc/rfc3484.txt">
 RFC 3484</a> order. If
 ...
 @throw IllegalArgumentExceptionif <code>timeoutMillis &lt; 0</code>.
 */
- (void)setConnectTimeoutWithInt:(jint)timeoutMillis;

/*!
 @brief Sets the internally used content handler factory.The content factory can
...
/*!
 @brief Sets the default value for <code>allowUserInteraction</code>.Unused by Android.
 */
...
/*!
 @brief Sets the default value for the flag indicating whether this connection
  allows to use caches.Existing <code>URLConnection</code>s are unaffected.
...
/*!
 @brief Sets the maximum time to wait for an input stream read to complete before
  giving up.Reading will fail with a <code>SocketTimeoutException</code> if the
  timeout elapses before data becomes available.
...
/*!
 @brief Sets the value of the specified request header field.The value will only
  be used by the current <code>URLConnection</code> instance.
 This method can
...
/*!
 ...
 @param url the URL which represents the resource this 
