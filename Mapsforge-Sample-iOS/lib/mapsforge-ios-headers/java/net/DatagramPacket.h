...
/*!
 @brief This class represents a datagram packet which contains data either to be sent
  or received through a <code>DatagramSocket</code>.It holds additional information
...
/*!
 ...
 @param data a byte array to store the read characters.
...
/*!
 ...
 <code>aPort</code> of the address <code>host</code>.The <code>length</code> must be
  lesser than or equal to the size of <code>data</code>.
 The first <code>length</code>
  bytes are sent.
 @param data a byte array which stores the characters to be sent.
 @param length the length of data.
 @param host the address of the target host.
...
/*!
 ...
 @param data a byte array to store the read characters.
 @param offset the offset of the byte array where the bytes is written.
...
/*!
 ...
 @param data a byte array which stores the characters to be sent.
 @param offset the offset of 
 <code>data</code>  where to read from.
 @param length the length of data.
 @param host the address of the target host.
 @param aPort the port of the target host.
 */
- (instancetype)initWithByteArray:(IOSByteArray *)data
                          withInt:(jint)offset
                          withInt:(jint)length
...
/*!
 @brief Constructs a new <code>DatagramPacket</code> object to send data to the
  address <code>sockAddr</code>.The <code>length</code> must be lesser than or equal
  to the size of <code>data</code>.
 The first <code>length</code> bytes of the data
  are sent.
 @param data the byte array to store the data.
 @param offset the offset of the data.
 @param length the length of the data.
 @param sockAddr the target host address and port.
...
/*!
 ...
 @param addr the target host address.
 */
- (void)setAddressWithJavaNetInetAddress:(JavaNetInetAddress *)addr;

/*!
 @brief Sets the data buffer for this datagram packet.The length of the datagram
...
/*!
 @brief Sets the length of the datagram packet.This length plus the offset must
  be lesser than or equal to the buffer size.
 @param length the length of this datagram packet.
 */
- (void)setLengthWithInt:(jint)length;

/*!
 @brief Sets the port number of the target host of this datagram packet.
 @param aPort the target host port number.
 */
...
/*!
 ...
 @param sockAddr the SocketAddress of the target host.
 */
