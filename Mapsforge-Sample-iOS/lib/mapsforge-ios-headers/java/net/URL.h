...
/*!
 ...
 <code>http://username:password@@host:8080/directory/file?query#ref</code>:
  ...
  <tr><td><code>Info</code></td><td><code>username:password</code></td><td></td></tr>
...
/*!
 ...
 @throw MalformedURLExceptionif <code>spec</code> could not be parsed as a
      URL.
 */
- (instancetype)initWithNSString:(NSString *)spec;

/*!
 @brief Creates a new URL of the given component parts.The URL uses the
 ...
 @throw MalformedURLExceptionif the combination of all arguments do not
...
/*!
 ...
 @param port the port, or <code>-1</code>  for the protocol's default port.
 @param file the name of the resource.
 @param handler the stream handler for this URL, or null for the      protocol's default stream handler.
 @throw MalformedURLExceptionif the combination of all arguments do not
      represent a valid URL or if the protocol is invalid.
 */
- (instancetype)initWithNSString:(NSString *)protocol
...
/*!
 ...
 @param context the URL to which <code>spec</code>  is relative, or null for
       no context in which case <code>spec</code>  must be an absolute URL.
 @param handler the stream handler for this URL, or null for the      protocol's default stream handler.
 @throw MalformedURLExceptionif the given string <code>spec</code> could not
...
/*!
 @brief Returns true if this URL equals <code>o</code>.URLs are equal if they have
...
/*!
 @brief Returns the content of the resource which is referred by this URL.By
...
/*!
 @brief Returns the default port number of the protocol used by this URL.If no
...
/*!
 ...
 <p>If this URL has no explicit port, connections opened using this URL
  will use its <code>port</code>.
 */
- (jint)getPort;

/*!
 @brief Returns the protocol of this URL like "http" or "file".This is also
  known as the scheme.
 The returned string is lower case.
 */
...
/*!
 ...
 @throw IOExceptionif an error occurs while opening the connection.
 */
...
/*!
 ...
 @throw IOExceptionif an I/O error occurs while opening the connection.
 @throw IllegalArgumentExceptionif the argument proxy is null or of is
      an invalid type.
 @throw UnsupportedOperationExceptionif the protocol handler does not
...
/*!
 ...
 @throw Errorif a URLStreamHandlerFactory has already been installed
      for the current VM.
 */
...
/*!
 ...
 @throw URISyntaxExceptionif this URL cannot be converted into a URI.
 */
- (JavaNetURI *)toURI;
...
/*!
 @brief Sets the properties of this URL using the provided arguments.Only a 
 <code>URLStreamHandler</code> can use this method to set fields of the
  existing URL instance.
 A URL is generally constant.
 */
...
/*!
 ...
 @throw MalformedURLExceptionif no reasonable handler is available.
 */
