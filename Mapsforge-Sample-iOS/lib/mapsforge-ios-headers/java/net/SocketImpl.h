...
/*!
 @brief Waits for an incoming request and blocks until the connection is opened
  on the given socket.
 @param newSocket the socket to accept connections on.
 @throw IOException
...
/*!
 ...
 @param address the local machine address to bind this socket to.
 @param port the port on the local machine to bind this socket to.
 @throw IOException
...
/*!
 @brief Closes this socket.This makes later access invalid.
 @throw IOException
...
/*!
 @brief Connects this socket to the specified remote host address and port
  number.
 @param address the remote host address this socket has to be connected to.
 @param port the remote port on which this socket has to be connected.
 @throw IOException
...
/*!
 @brief Connects this socket to the remote host address and port number specified
  by the <code>SocketAddress</code> object with the given timeout.This method
  will block indefinitely if the timeout is set to zero.
 @param remoteAddr the remote host address and port number to connect to.
...
/*!
 ...
 @param host the remote host this socket has to be connected to.
 @param port the remote port on which this socket has to be connected.
 @throw IOException
 if an error occurs while connecting to the remote host.
 */
...
/*!
 @brief Creates a new unconnected socket.The argument <code>isStreaming</code>
  defines whether the new socket is a streaming or a datagram socket.
 @param isStreaming defines whether the type of the new socket is streaming or
              datagram.
 @throw IOException
...
/*!
 @brief Gets the local port number of this socket.The field is initialized to 
 <code>-1</code> and upon demand will go to the IP stack to get the bound
  value.
 See the class comment for the context of the local port.
...
/*!
 @brief Gets the remote port number of this socket.This value is not meaningful
...
/*!
 @brief Listens for connection requests on this streaming socket.Incoming
 ...
 @param backlog the maximum number of outstanding connection requests.
 @throw IOException
...
/*!
 ...
 @param value the byte of urgent data.
 @throw IOException
...
/*!
 ...
 @param connectionTime the importance of connect time.
 @param latency the importance of latency.
 @param bandwidth the importance of bandwidth.
 */
...
/*!
 @brief Returns whether the socket supports urgent data or not.Subclasses should
