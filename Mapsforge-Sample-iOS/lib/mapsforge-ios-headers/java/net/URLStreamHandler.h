...
/*!
 @brief Returns the default port of the protocol used by the handled URL.The
...
/*!
 @brief Establishes a new connection to the resource specified by the URL <code>u</code>
  using the given <code>proxy</code>.Since different protocols also have
...
/*!
 @brief Parses the clear text URL in <code>str</code> into a URL object.URL strings
  generally have the following format: 
 <p>
  http://www.company.com/java/file1.java#reference 
 <p>
  The string is parsed in HTTP format.
 If the protocol has a different URL
