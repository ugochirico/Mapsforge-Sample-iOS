...
/*!
 @brief This class represents a server-side socket that waits for incoming client
  connections.A <code>ServerSocket</code> handles the requests and sends back an
  appropriate reply.
 The actual tasks that a server socket must accomplish are
...
/*!
 ...
 @throw IOExceptionif an error occurs while creating the socket.
 */
- (instancetype)init;
...
/*!
 @brief Constructs a new <code>ServerSocket</code> instance bound to the given <code>localAddress</code>
  and <code>port</code>.The backlog is set to <code>backlog</code>.
...
/*!
 @brief Binds this server socket to the given local socket address with a maximum
  backlog of 50 unaccepted connections.If the <code>localAddr</code> is set to 
 <code>null</code> the socket will be bound to an available local address on
  any free port of the system.
 @param localAddr the local address and port to bind on.
...
/*!
 @brief Binds this server socket to the given local socket address.If the 
 ...
 @throw IllegalArgumentExceptionif the <code>SocketAddress</code> is not
      supported.
 @throw IOExceptionif the socket is already bound or a problem occurs
      during binding.
 */
- (void)bindWithJavaNetSocketAddress:(JavaNetSocketAddress *)localAddr
                             withInt:(jint)backlog;
...
/*!
 @brief Closes this server socket and its implementation.Any attempt to connect
...
/*!
 @brief Returns this socket's <code>ServerSocketChannel</code>, if one exists.A channel is
...
/*!
 ...
 <code>null</code> otherwise.This is useful for multihomed hosts.
...
/*!
 ...
 @param reuse the socket option setting.
 @throw SocketException
...
/*!
 @brief Sets the server socket implementation factory of this instance.This
  method may only be invoked with sufficient security privilege and only
  once during the application lifetime.
 @param aFactory the streaming socket factory to be used for further socket
              instantiations.
 @throw IOException
...
/*!
 @brief Returns a textual representation of this server socket including the
  address, port and the state.The port field is set to <code>0</code> if there
...
/*!
 ...
 @param aSocket the concrete 
 <code>SocketImpl</code>  to accept the connection             request on.
 @throw IOException
