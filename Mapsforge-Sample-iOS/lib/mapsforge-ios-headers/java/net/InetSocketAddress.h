...
/*!
 @brief This class represents a socket endpoint described by a IP address and a port
  number.It is a concrete implementation of <code>SocketAddress</code> for IP.
 */
...
/*!
 ...
 <code>address</code>.The range for valid port numbers is between 0 and 65535
  inclusive.
 If <code>address</code> is <code>null</code> this socket is bound to the
...
/*!
 @brief Creates a socket endpoint with the given port number <code>port</code> and the
  hostname <code>host</code>.The hostname is tried to be resolved and cannot be 
 <code>null</code>.
...
/*!
 @brief Creates an <code>InetSocketAddress</code> without trying to resolve the
  hostname into an <code>InetAddress</code>.The address field is marked as
  unresolved.
 @param host the specified hostname to which this socket is bound.
 @param port the specified port number to which this socket is bound.
...
/*!
 @brief Compares two socket endpoints and returns true if they are equal.Two
...
/*!
 @brief Returns the hostname, doing a reverse DNS lookup on the <code>InetAddress</code> if no
  hostname string was provided at construction time.Use <code>getHostString</code> to
