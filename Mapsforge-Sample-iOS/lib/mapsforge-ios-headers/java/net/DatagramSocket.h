...
/*!
 ...
 <code>aPort</code> on the localhost.Valid values for <code>aPort</code> are
...
/*!
 @brief Constructs a UDP datagram socket which is bound to the specific local
  address <code>addr</code> on port <code>aPort</code>.Valid values for <code>aPort</code>
...
/*!
 ...
 @param localAddr the local machine address and port to bind to.
...
/*!
 ...
 Future calls to <code>send</code> will use this as the default target, and <code>receive</code>
  will only accept packets from this source.
 @throw SocketExceptionif an error occurs.
 */
- (void)connectWithJavaNetSocketAddress:(JavaNetSocketAddress *)peer;

/*!
 @brief Disconnects this UDP datagram socket from the remote host.This method
...
/*!
 @brief Returns this socket's <code>DatagramChannel</code>, if one exists.A channel is
 ...
 <code>java.nio.channels.DatagramChannel</code>.
 */
...
/*!
 @brief Gets the socket <code>timeout</code>.
 @throw SocketException
...
/*!
 @brief Returns true if this socket is bound to a local address.See <code>bind</code>.
 */
- (jboolean)isBound;
...
/*!
 @brief Returns true if this datagram socket is connected to a remote address.See <code>connect</code>.
 */
...
/*!
 ...
 .All fields of <code>pack</code> must be set according to the data
  received.
 If the received data is longer than the packet buffer size it
  is truncated. This method blocks until a packet is received or a timeout
  has expired.
 @param pack the 
 <code>DatagramPacket</code>  to store the received data.
 @throw IOException
...
/*!
 ...
 @param pack the 
 <code>DatagramPacket</code>  which has to be sent.
 @throw IOException
...
/*!
 @brief Sets the socket option <code>SocketOptions.SO_BROADCAST</code>.This option
  must be enabled to send broadcast messages.
 @param broadcast the socket option value to enable or disable this option.
 @throw SocketException
...
/*!
 @brief Sets the socket implementation factory.This may only be invoked once
  over the lifetime of the application.
 This factory is used to create
  a new datagram socket implementation.
 @param fac the socket factory to use.
 @throw IOException
...
/*!
 @brief Sets the socket option <code>SocketOptions.SO_REUSEADDR</code>.This option
  has to be enabled if more than one UDP socket wants to be bound to the
  same address.
 That could be needed for receiving multicast packets. 
 <p>
  There is an undefined behavior if this option is set after the socket is
  already bound.
 @param reuse the socket option value to enable or disable this option.
 @throw SocketException
 if the socket is closed or the option could not be set.
 */
...
/*!
 @brief Sets the <code>timeout</code> in milliseconds for this socket.
...
/*!
 @brief Sets the {@@see SocketOptions#IP_TOS} value for every packet sent by this socket.
 @throw SocketException
 if the socket is closed or the option could not be set.
 */
...
/*!
 @brief Constructs a new <code>DatagramSocket</code> using the specific datagram
  socket implementation <code>socketImpl</code>.The created <code>DatagramSocket</code>
  will not be bound.
 @param socketImpl the DatagramSocketImpl to use.
 */
