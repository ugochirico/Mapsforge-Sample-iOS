...
/*!
 ...
 @throw IllegalArgumentExceptionif <code>localAddress</code> is not supported (because it's not
...
/*!
 @brief Returns an address of the outgoing network interface used by this socket.To avoid
...
/*!
 @brief Adds this socket to the specified multicast group.A socket must join a
  group before data may be received.
 A socket may be a member of multiple
  groups but may join any group only once.
 @param groupAddr the multicast group to be joined.
 @throw IOExceptionif an error occurs.
 */
...
/*!
 ...
 A socket may be a member of multiple
  groups but may join any group only once.
 @param groupAddress the multicast group to be joined.
 @param netInterface the network interface on which the datagram packets will be
              received.
 @throw IOException
...
/*!
 ...
 @param groupAddr the multicast group to be left.
...
/*!
 @brief Removes this socket from the specified multicast group.
 @param groupAddress the multicast group to be left.
 @param netInterface the network interface on which the addresses should be
              dropped.
 @throw IOException
 if the specified group address is not a multicast address.
 @throw IllegalArgumentException
...
/*!
 @brief Sends the given <code>packet</code> on this socket, using the given <code>ttl</code>.This method is
...
/*!
 @brief Sets the outgoing network interface used by this socket.The interface used is the first
  interface found to have the given <code>address</code>.
