...
/*!
 @brief Defines an interface for socket implementations to get and set socket
  options.It is implemented by the classes <code>SocketImpl</code> and <code>DatagramSocketImpl</code>
 .
 - seealso: SocketImpl
...
/*!
 ...
 @param optID the option identifier.
...
/*!
 ...
 @param optID the option identifier.
 @param val the value to be set for the option.
 @throw SocketException
...
/*!
 @brief Number of seconds to wait when closing a socket if there is still some buffered data to be
  sent.
 <p>The option can be set to disabled using <code>Object)</code> with a value of 
...
/*!
 @brief Integer timeout in milliseconds for blocking accept or read/receive operations (but not
  write/send operations).A timeout of 0 means no timeout.
 Negative
...
/*!
 @brief The size in bytes of a socket's send buffer.This must be an integer greater than 0.
...
/*!
 @brief The size in bytes of a socket's receive buffer.This must be an integer greater than 0.
 This is a hint to the kernel; the kernel may use a larger buffer. 
...
/*!
 @brief This integer option specifies the value for the type-of-service field of the IPv4 header,
  ...
  socket options.
 These may be ignored by the underlying OS. Values must be between 0 and 255
  inclusive. 
...
/*!
 @brief This boolean option can be used to enable or disable broadcasting on datagram sockets.This
  option must be enabled to send broadcast messages.
