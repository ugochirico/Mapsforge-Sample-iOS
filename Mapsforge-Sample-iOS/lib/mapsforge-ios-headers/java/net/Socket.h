...
/*!
 @brief Creates a new unconnected socket.When a SocketImplFactory is defined it
...
/*!
 @brief Creates a new streaming socket connected to the target host specified by
  the parameters <code>dstAddress</code> and <code>dstPort</code>.The socket is
...
/*!
 @brief Creates a new streaming or datagram socket connected to the target host
  specified by the parameters <code>addr</code> and <code>port</code>.The socket is
  bound to any available port on the local host.
 @param addr the Internet address to connect to.
 @param port the port on the target host to connect to.
 @param streaming if 
 <code>true</code>  a streaming socket is returned, a datagram             socket otherwise.
 @throw IOException
 if an error occurs while creating the socket.
 */
...
/*!
 @brief Creates a new streaming socket connected to the target host specified by
  the parameters <code>dstAddress</code> and <code>dstPort</code>.On the local
...
/*!
 @brief Creates a new unconnected socket using the given proxy type.When a 
...
/*!
 @brief Creates a new streaming socket connected to the target host specified by
  the parameters <code>dstName</code> and <code>dstPort</code>.The socket is bound
...
/*!
 @brief Creates a new streaming or datagram socket connected to the target host
  specified by the parameters <code>hostName</code> and <code>port</code>.The socket
  is bound to any available port on the local host.
 <p>This implementation tries each IP address for the given hostname (in 
 <a href="http://www.ietf.org/rfc/rfc3484.txt">RFC 3484</a> order)
  until it either connects successfully or it exhausts the set.
 @param hostName the target host name or IP address to connect to.
 @param port the port on the target host to connect to.
 @param streaming if 
 <code>true</code>  a streaming socket is returned, a datagram             socket otherwise.
 @throw UnknownHostException
...
/*!
 @brief Creates a new streaming socket connected to the target host specified by
  the parameters <code>dstName</code> and <code>dstPort</code>.On the local endpoint
  the socket is bound to the given address <code>localAddress</code> on port 
 <code>localPort</code>.
 If <code>host</code> is <code>null</code> a loopback address is used to connect to. 
 <p>This implementation tries each IP address for the given hostname (in 
 <a href="http://www.ietf.org/rfc/rfc3484.txt">RFC 3484</a> order)
  until it either connects successfully or it exhausts the set.
 @param dstName the target host name or IP address to connect to.
...
/*!
 @brief Binds this socket to the given local host address and port specified by
  the SocketAddress <code>localAddr</code>.If <code>localAddr</code> is set to 
...
/*!
 @brief Closes the socket.It is not possible to reconnect or rebind to this
...
/*!
 @brief Connects this socket to the given remote host address and port specified
  by the SocketAddress <code>remoteAddr</code> with the specified timeout.The
  connecting method will block until the connection is established or an
  error occurred.
 @param remoteAddr the address and port of the remote host to connect to.
 @param timeout the timeout value in milliseconds or 
 <code>0</code>  for an infinite             timeout.
 @throw IllegalArgumentException
...
/*!
 @brief Returns this socket's <code>SocketChannel</code>, if one exists.A channel is
  available only if this socket wraps a channel.
 (That is, you can go from a
 ...
 <code>java.nio.channels.ServerSocketChannel</code> or 
...
/*!
 @brief Returns an input stream to read data from this socket.If the socket has an associated 
...
/*!
 @brief Returns the local port this socket is bound to, or -1 if the socket is unbound.If the socket
...
/*!
 @brief Returns an output stream to write data into this socket.If the socket has an associated 
...
/*!
 @brief Returns this socket's <code>buffer size</code>.
 */
...
/*!
 @brief Returns this socket's <code>timeout</code>.
 */
- (jint)getSoTimeout;
...
/*!
 @brief Returns this socket's {@@see SocketOptions#IP_TOS} setting.
 */
...
/*!
 ...
 @param connectionTime the value representing the importance of a short connecting
              time.
...
/*!
 @brief Sets this socket's <code>buffer size</code>.
 */
...
/*!
 @brief Sets the internal factory for creating socket implementations.This may
  only be executed once during the lifetime of the application.
 @param fac the socket implementation factory to be set.
 @throw IOException
...
/*!
 @brief Sets this socket's <code>timeout</code> in milliseconds.
...
/*!
 @brief Closes the input stream of this socket.Any further data sent to this
...
/*!
 @brief Closes the output stream of this socket.All buffered data will be sent
  followed by the termination sequence.
 Writing to the closed output stream
