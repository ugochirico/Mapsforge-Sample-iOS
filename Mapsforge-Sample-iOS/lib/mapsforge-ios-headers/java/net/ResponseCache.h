...
/*!
 @brief Allows the protocol handler to cache data after retrieving resources.The
  <code>ResponseCache</code> decides whether the resource data should be cached
  or not.
 If so, this method returns a <code>CacheRequest</code> to write the
  resource data to. Otherwise, this method returns <code>null</code>.
 @param uri the reference to the requested resource.
 @param connection the connection to fetch the response.
...
/*!
 @brief Sets the system's default response cache.Use null to remove the response cache.
 */
