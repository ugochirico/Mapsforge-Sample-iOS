...
/*!
 @brief This class is used to represent a network interface of the local device.An
  interface is defined by its address and a platform dependent name.
 The class
...
/*!
 ...
 @throw SocketExceptionif an error occurs.
 @throw NullPointerExceptionif <code>address == null</code>.
 */
...
/*!
 ...
 @throw SocketExceptionif an error occurs.
 @throw NullPointerExceptionif <code>interfaceName == null</code>.
 */
+ (JavaNetNetworkInterface *)getByNameWithNSString:(NSString *)interfaceName;

/*!
 @brief Returns a human-readable name for this network interface.On Android, this is the same
...
/*!
 @brief Returns the hash code for this <code>NetworkInterface</code>.Since the
...
/*!
 @brief Returns true if this interface is a virtual interface (also called
  ...
  (like address or MTU).
 Usually the name of the interface will the name of
