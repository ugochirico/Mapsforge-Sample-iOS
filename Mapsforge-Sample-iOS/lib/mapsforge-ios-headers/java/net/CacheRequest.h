...
/*!
 ...
 <code>ResponseCache</code>.A protocol handler calls the <code>OutputStream</code>
  which is provided by the <code>CacheRequest</code> object, to store the resource
  data into the cache.
 It also allows the user to interrupt and abort the
...
/*!
 @brief Aborts the current cache operation.If an <code>IOException</code> occurs
