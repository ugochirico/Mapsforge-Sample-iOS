...
/*!
 ...
 @param dst the destination long array.
 @return this buffer.
 @throw BufferUnderflowException
...
/*!
 ...
 @param dst the target long array.
 @param dstOffset the offset of the long array, must not be negative and not
              greater than 
 <code>dst.length</code> .
 @param longCount the number of longs to read, must be no less than zero and not
              greater than 
...
/*!
 @brief Writes longs from the given long array, starting from the specified
  ...
  of longs written.
 @param src the source long array.
 @param srcOffset the offset of long array, must not be negative and not greater
              than <code>src.length</code>
  .
 @param longCount the number of longs to write, must be no less than zero and
              not greater than 
...
/*!
 ...
 @param start the start index, must not be negative and not greater than
  ...
  .
 @param longCount the length, must not be negative and not greater than
