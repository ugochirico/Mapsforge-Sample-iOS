...
/*!
 ...
 @param dst the destination short array.
 @return this buffer.
 @throw BufferUnderflowException
...
/*!
 ...
 @param dst the target short array.
 @param dstOffset the offset of the short array, must not be negative and not
              greater than 
 <code>dst.length</code> .
 @param shortCount the number of shorts to read, must be no less than zero and
              not greater than 
...
/*!
 @brief Writes shorts from the given short array, starting from the specified
  ...
  of shorts written.
 @param src the source short array.
 @param srcOffset the offset of short array, must not be negative and not
              greater than 
 <code>src.length</code> .
 @param shortCount the number of shorts to write, must be no less than zero and
              not greater than 
...
/*!
 ...
 @param start the start index, must not be negative and not greater than
  ...
  .
 @param shortCount the length, must not be negative and not greater than
