...
/*!
 ...
 @param dst the destination int array.
 @return this buffer.
 @throw BufferUnderflowException
...
/*!
 @brief Reads ints from the current position into the specified int array,
  ...
  number of ints read.
 @param dst the target int array.
 @param dstOffset the offset of the int array, must not be negative and not
              greater than 
 <code>dst.length</code> .
 @param intCount the number of ints to read, must be no less than zero and not
              greater than 
...
/*!
 @brief Writes ints from the given int array, starting from the specified offset,
  ...
  written.
 @param src the source int array.
 @param srcOffset the offset of int array, must not be negative and not greater
              than <code>src.length</code>
  .
 @param intCount the number of ints to write, must be no less than zero and not
              greater than 
...
/*!
 ...
 @param intCount the length, must not be negative and not greater than
