...
/*!
 @brief Checks whether this double buffer is equal to another object.If <code>other</code>
...
/*!
 ...
 @param dst the destination double array.
 @return this buffer.
 @throw BufferUnderflowException
...
/*!
 ...
 @param dst the target double array.
 @param dstOffset the offset of the double array, must not be negative and not
              greater than 
 <code>dst.length</code> .
 @param doubleCount the number of doubles to read, must be no less than zero and
              not greater than 
...
/*!
 @brief Writes doubles from the given double array, starting from the specified
  ...
  of doubles written.
 @param src the source double array.
 @param srcOffset the offset of double array, must not be negative and not
              greater than 
 <code>src.length</code> .
 @param doubleCount the number of doubles to write, must be no less than zero and
              not greater than 
...
/*!
 ...
 @param start the start index, must not be negative and not greater than
  ...
  .
 @param doubleCount the length, must not be negative and not greater than
