...
/*!
 ...
 @param csq the 
 <code>CharSequence</code>  to write.
 @return this buffer.
 @throw BufferOverflowException
...
/*!
 ...
 @param end the last char to write (excluding), must be less than
              <code>start</code>
   and not greater than <code>csq.length()</code> .
 @return this buffer.
 @throw BufferOverflowException
...
/*!
 ...
 @throw IndexOutOfBoundsExceptionif <code>index < 0</code> or <code>index >= remaining()</code>.
 */
...
/*!
 ...
 @param dstOffset the offset of the char array, must not be negative and not
              greater than 
 <code>dst.length</code> .
 @param charCount The number of chars to read, must be no less than zero and no
              greater than 
...
/*!
 @brief Writes chars from the given char array, starting from the specified offset,
  ...
  written.
 @param src the source char array.
 @param srcOffset the offset of char array, must not be negative and not greater
              than <code>src.length</code>
  .
 @param charCount the number of chars to write, must be no less than zero and no
              greater than 
...
/*!
 ...
 @param end the last char to write (excluding), must be less than
              <code>start</code>
   and not greater than <code>str.length()</code> .
 @return this buffer.
 @throw BufferOverflowException
 if <code>remaining()</code> is less than <code>end - start</code>.
 @throw IndexOutOfBoundsException
...
/*!
 @brief Reads characters from this buffer and puts them into <code>target</code>.The
...
/*!
 ...
 <p>
  ...
  buffer's change of content will be visible to the other. The two buffers'
  position, limit and mark are independent.
 @param start the start index of the sub-sequence, referenced from the
 ...
 @param end the end index of the sub-sequence, referenced from the current
              buffer position. Must not be less than 
 <code>start</code>  and not             be greater than the value obtained from a call to
              <code>remaining()</code>
  .
...
/*!
 ...
 @param start the start index, must not be negative and not greater than
  ...
  .
 @param charCount the length, must not be negative and not greater than
...
/*!
 ...
 <code>end</code>, capacity will be the length of the char sequence. The new
  buffer is read-only.
 @param cs the char sequence which the new buffer will be based on.
 @param start the start index, must not be negative and not greater than
              <code>cs.length()</code>
  .
 @param end the end index, must be no less than 
