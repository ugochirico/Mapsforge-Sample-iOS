...
/*!
 @brief Sets the blocking mode of this channel.A call to this method blocks if
  other calls to this method or to <code>register</code> are executing.
 The
 ...
 @param blockingMode<code>true</code>
   for setting this channel's mode to blocking,             <code>false</code>
...
/*!
 ...
 @param selector the selector with which this channel has been registered.
...
/*!
 ...
 <code>set</code> is updated to <code>interestSet</code> and
  the corresponding selection key is returned.
 ...
 @param selector the selector with which to register this channel.
 @param interestSet this channel's 
 <code>set</code> .
 @param attachment the object to attach, can be 
 <code>null</code> .
...
/*!
 ...
 @param selectorProvider the selector provider that creates this channel.
 */
- (instancetype)initWithJavaNioChannelsSpiSelectorProvider:(JavaNioChannelsSpiSelectorProvider *)selectorProvider;

/*!
 @brief Implements the channel closing behavior.Calls
...
/*!
 @brief Implements the closing function of the SelectableChannel.This method is
