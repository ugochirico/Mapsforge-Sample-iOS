...
/*!
 @brief Closes this selector.This method does nothing if this selector is
  already closed.
 The actual closing must be implemented by subclasses in 
...
/*!
 ...
 @param operations the <code>set</code>  of <code>channel</code>
  .
