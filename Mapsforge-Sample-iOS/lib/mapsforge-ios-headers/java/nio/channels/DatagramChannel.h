...
/*!
 @brief A <code>DatagramChannel</code> is a selectable channel that represents a partial
  abstraction of a datagram socket.The <code>socket</code> method of this class can
...
/*!
 ...
 @param address the address to be connected to.
 @return this channel.
...
/*!
 ...
 @param targets the byte buffers to store the received datagram.
...
/*!
 ...
 - seealso: java.nio.channels.ScatteringByteChannel
 @param targets the byte buffers to store the received datagram.
 @param offset a non-negative offset in the array of buffers, pointing to the
              starting buffer to store the bytes transferred, must not be
              bigger than 
 <code>targets.length</code> .
 @param length a non-negative length to indicate the maximum number of
...
/*!
 @brief Sends a datagram through this channel.The datagram consists of the
 ...
 @param address the destination address for the datagram.
...
/*!
 @brief Gets the valid operations of this channel.Datagram channels support read
...
/*!
 ...
 @param source the byte buffer as the source of the datagram.
...
/*!
 ...
 @param sources the byte buffers as the source of the datagram.
