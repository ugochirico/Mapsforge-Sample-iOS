...
/*!
 @brief A channel that can be used with a <code>Selector</code>.The channel must be
  registered with a selector by calling one of the <code>register</code> methods,
  which return a <code>SelectionKey</code> object.
 In order to deregister a channel
...
/*!
 ...
 @param sel the selector with which this channel has been registered.
...
/*!
 ...
 <code>set</code> is updated to <code>operations</code>.
 The
 ...
 @param operations this channel's 
 <code>set</code> .
...
/*!
 @brief Registers this channel with the specified selector for the specified
  ...
  but its <code>set</code> is updated to <code>ops</code> and
  the attached object is updated to <code>att</code>.
 The returned key is
 ...
 <p>
  ...
  the key set of the selector and thus may again block if other threads
  also hold locks on the key set of the same selector.
 @param sel the selector with which to register this channel.
 @param ops this channel's 
 <code>set</code> .
 @param att the object to attach, can be 
 <code>null</code> .
 @return the selection key for this registration.
 @throw ClosedChannelException
 if this channel is closed.
