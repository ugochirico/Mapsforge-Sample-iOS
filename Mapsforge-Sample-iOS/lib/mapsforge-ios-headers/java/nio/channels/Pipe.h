...
/*!
 @brief A pipe contains two channels, forming a unidirectional pipe.One is the writable sink channel,
  and the other is the readable source channel.
 When bytes are written into the writable
...
/*!
 @brief Returns a new pipe from the default {@@see java.nio.channels.spi.SelectorProvider}.
 @throw IOException
...
/*!
 ...
 @param provider the provider of the channel.
 */
