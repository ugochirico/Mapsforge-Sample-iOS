...
/*!
 @brief Closes this selector.Ongoing calls to the <code>select</code> methods of this
  selector will get interrupted.
 This interruption behaves as if the 
...
/*!
 @brief Gets the set of registered keys.The set is immutable and is not thread-
  safe.
...
/*!
 @brief Detects if any of the registered channels is ready for I/O operations
  according to its <code>set</code>.This method does not
...
/*!
 @brief Gets the selection keys whose channels are ready for operation.The set
  is not thread-safe and no keys may be added to it.
 Removing keys is
  allowed.
...
/*!
 @brief Detects if any of the registered channels is ready for I/O operations
  according to its <code>set</code>.This operation will
  return immediately.
