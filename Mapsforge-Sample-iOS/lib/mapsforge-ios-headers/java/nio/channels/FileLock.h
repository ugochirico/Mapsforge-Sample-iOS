...
/*!
 @brief Indicates whether this lock is a valid file lock.The lock is
...
/*!
 ...
 @param start the starting position for the comparative lock.
 @param length the length of the comparative lock.
...
/*!
 @brief Releases this particular lock on the file.If the lock is invalid then
...
/*!
 @brief Constructs a new file lock instance for a given channel.The constructor
  enforces the starting position, length and sharing mode of the lock.
 @param channel the underlying file channel that holds the lock.
 @param position the starting point for the lock.
 @param size the length of the lock in number of bytes.
 @param shared the lock's sharing mode of lock; 
 <code>true</code>  is shared,             <code>false</code>
   is exclusive.
 */
