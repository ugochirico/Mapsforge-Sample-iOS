...
/*!
 @brief Attaches an object to this key.It is acceptable to attach <code>null</code>,
  this discards the old attachment.
 @param anObject the object to attach, or 
 <code>null</code>  to discard the current             attachment.
...
/*!
 @brief Gets this key's <code>set</code>.The returned set has
...
/*!
 @brief Sets the <code>set</code> for this key.
 @param operations the new interest set.
 @return this key.
 @throw IllegalArgumentException
 if a bit in <code>operations</code> is not in the set of
              <code>operations</code> of this
              key's channel.
 @throw CancelledKeyException
 if the key has already been canceled.
 */
...
/*!
 @brief Gets the set of operations that are ready.The returned set has only
