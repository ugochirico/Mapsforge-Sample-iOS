...
@interface JavaNioBuffer : NSObject {
 @public
  ...
  jint mark_;
  /*!
   @brief The current position of this buffer.Position is always no less than zero
...
/*!
 ...
 @return the array
 @throw ReadOnlyBufferExceptionif the buffer is read-only
...
/*!
 @brief Returns the offset into the array returned by <code>array</code> of the first
  ...
  not necessarily the 0th element in the array.
 Use 
...
/*!
 @brief Returns true if <code>array</code> and <code>arrayOffset</code> won't throw.This method does not
