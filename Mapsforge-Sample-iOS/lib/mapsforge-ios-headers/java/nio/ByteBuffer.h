...
/*!
 ...
 <p>
  ...
  as this buffer's. The duplicated buffer's read-only property is the same as this buffer's. 
...
/*!
 ...
 @param dstOffset the offset of the byte array, must not be negative and
              not greater than 
 <code>dst.length</code> .
 @param byteCount the number of bytes to read, must not be negative and not
              greater than 
 <code>dst.length - dstOffset</code>
 @return <code>this</code>
 @throw IndexOutOfBoundsExceptionif <code>dstOffset < 0 ||  byteCount < 0</code>
 @throw BufferUnderflowExceptionif <code>byteCount > remaining()</code>
 */
- (JavaNioByteBuffer *)getWithByteArray:(IOSByteArray *)dst
...
/*!
 ...
 @param byteOrder the byte order to set. If 
 <code>null</code>  then the order             will be 
...
/*!
 @brief Writes bytes in the given byte array, starting from the specified offset,
  ...
  written.
 @param src the source byte array.
 @param srcOffset the offset of byte array, must not be negative and not greater
              than <code>src.length</code>
  .
 @param byteCount the number of bytes to write, must not be negative and not
              greater than 
...
/*!
 ...
 @param start the start index, must not be negative and not greater than
  ...
  .
 @param byteCount the length, must not be negative and not greater than
