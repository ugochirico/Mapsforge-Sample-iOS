...
/*!
 @brief Returns the host name of the peer of this session.The host name is not
  authenticated.
...
/*!
 @brief Returns the port number of the peer of this session.The port number is
  not authenticated.
