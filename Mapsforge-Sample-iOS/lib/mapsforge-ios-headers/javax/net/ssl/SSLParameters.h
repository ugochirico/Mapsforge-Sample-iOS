...
/*!
 @brief The default SSLParameters constructor.Cipher suites and
...
/*!
 ...
 @param cipherSuites An array of cipherSuites that is cloned for  use within the SSLParameters, or null.
 */
...
/*!
 @brief A SSLParameters constructor that allows the values for initial
  ...
  default as specified in <code>SSLParameters()</code>.
 @param cipherSuites An array of cipher names that is cloned for  use within the SSLParameters, or null.
 @param protocols An array of protocol names that is cloned for  use within the SSLParameters, or null.
 */
- (instancetype)initWithNSStringArray:(IOSObjectArray *)cipherSuites
...
/*!
 @brief Returns true if a server requires authentication from a client
  during handshaking.If this returns true, <code>getWantClientAuth</code>
  will return false.
 */
...
/*!
 @brief Returns true if a server optionally wants to authenticate a
  client during handshaking.If this returns true, <code>getNeedClientAuth</code>
  will return false.
 */
