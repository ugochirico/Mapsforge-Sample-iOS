...
/*!
 @brief Initializes this <code>SSLContext</code> instance.All of the arguments are
  optional, and the security providers will be searched for the required
  implementations of the needed algorithms.
 @param km the key sources or 
 <code>null</code> .
 @param tm the trust decision sources or 
 <code>null</code> .
 @param sr the randomness source or 
 <code>null.</code>
