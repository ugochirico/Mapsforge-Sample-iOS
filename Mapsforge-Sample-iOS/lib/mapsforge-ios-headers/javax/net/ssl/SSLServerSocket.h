...
/*!
 @brief Sets the names of the protocols to be enabled for new connections.Only
...
/*!
 ...
 @param mode<code>true</code>
   if new connections should act in client mode,             <code>false</code>
   if not.
 */
...
/*!
 ...
 @param port the port to listen on.
 @param backlog the number of pending connections to queue.
 @throw IOException
 if creating the socket fails.
 */
- (instancetype)initWithInt:(jint)port
...
/*!
 ...
 @param backlog the number of pending connections to queue.
 @param address the address of the interface to accept connections on.
 @throw IOException
 if creating the socket fails.
 */
- (instancetype)initWithInt:(jint)port
