...
/*!
 @brief An <code>HttpURLConnection</code> for HTTPS (<a href="http://tools.ietf.org/html/rfc2818">
 RFC 2818</a>).A
...
@interface JavaxNetSslHttpsURLConnection : JavaNetHttpURLConnection {
 @public
  /*!
   @brief The host name verifier used by this connection.It is initialized from
...
/*!
 @brief Returns the list of local certificates used during the handshake.These
...
/*!
 ...
 @param v the new default hostname verifier
...
/*!
 ...
 @param sf the new default SSL socket factory.
 @throw IllegalArgumentException
...
/*!
 ...
 @param v the hostname verifier for this instance.
 @throw IllegalArgumentException
 if the specified verifier is <code>null</code>.
 */
...
/*!
 ...
 @param sf the SSL socket factory to be used by this instance.
 @throw IllegalArgumentException
 if the specified socket factory is <code>null</code>.
 */
