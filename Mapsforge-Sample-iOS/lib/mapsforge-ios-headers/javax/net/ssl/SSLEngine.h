...
/*!
 @brief Returns a delegate task for this engine instance.Some engine operations
 ...
 <code>SSLEngineResult</code> instances returned by this engine may indicate
  that a delegated task result is needed.
 In this case the 
...
/*!
 @brief Returns the protocol names that are supported by this engine.These
...
/*!
 @brief Sets the SSL cipher suite names that should be enabled in this engine
  instance.Only cipher suites listed by <code>getSupportedCipherSuites()</code>
  are allowed.
...
/*!
 @brief Sets the protocol version names that should be enabled in this engine
  instance.Only protocols listed by <code>getSupportedProtocols()</code> are
  allowed.
...
/*!
 ...
 @param flag<code>true</code>
   if new SSL sessions may be established,             <code>false</code>
   if existing SSL sessions must be reused.
 */
- (void)setEnableSessionCreationWithBoolean:(jboolean)flag;

/*!
 @brief Sets whether this engine must require client authentication.The client
 ...
 @param need<code>true</code>
   if client authentication is required,             <code>false</code>
...
/*!
 ...
 @param mode<code>true</code>
   if this engine should act in client mode,             <code>false</code>
   if not.
 @throw IllegalArgumentException
...
/*!
 @brief Sets whether this engine should request client authentication.The client
 ...
 @param want<code>true</code>
   if client authentication should be requested,             <code>false</code>
   if no authentication is needed.
 */
