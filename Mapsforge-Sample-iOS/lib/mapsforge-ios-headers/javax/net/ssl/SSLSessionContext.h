...
/*!
 ...
 @param sessionId the session identifier of the session to look up.
...
/*!
 @brief Returns the timeout for sessions in this session context.Sessions
...
/*!
 ...
 @param size the size of the session cache, or 
 <code>zero</code>  for unlimited             cache size.
...
/*!
 @brief Sets the timeout for sessions in this context.Sessions exceeding the
  timeout are invalidated.
 @param seconds the timeout in seconds, or 
 <code>zero</code>  if unlimited.
 @throw IllegalArgumentException
